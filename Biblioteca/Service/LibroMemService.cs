...
namespace Biblioteca.Services
{
    public class LibroMemService : ILibroService
    {
        ...
        {
            new Libro { Id = 1, IdAutor = 1, Titulo = "Cien Años de Soledad", Descripcion = "La novela narra la historia de la familia Buendía a lo largo de siete generaciones en el pueblo ficticio de Macondo.", Genero = "Realismo Mágico", ISBN = "978-0307474728", FechaPublicacion = new DateTime(1967, 1, 1), FechaEdicion = new DateTime(2003, 1, 1), Edicion = "Edición Conmemorativa" },
            new Libro { Id = 2, IdAutor = 2, Titulo = "Rayuela", Descripcion = "La novela es conocida por su estructura, que permite al lector elegir entre leer la novela de forma lineal o seguir un orden de capítulos no secuencial.", Genero = "Novela", ISBN = "978-8437604034", FechaPublicacion = new DateTime(1963, 1, 1), FechaEdicion = new DateTime(2019, 1, 1), Edicion = "Edición Cátedra" },
            new Libro { Id = 3, IdAutor = 3, Titulo = "La Ciudad y los Perros", Descripcion = "La novela narra las vivencias de un grupo de jóvenes internos en un colegio militar en Lima, Perú.", Genero = "Novela", ISBN = "978-8466333868", FechaPublicacion = new DateTime(1963, 1, 1), FechaEdicion = new DateTime(2016, 1, 1), Edicion = "Edición Alfaguara" }
        };
